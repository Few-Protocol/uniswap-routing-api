import { encodeSqrtRatioX96, Pool } from '@fewprotocol/uniswap-v3-sdk'
import { FeeAmount } from '../utils/ticks'
import { V3PoolAccessor } from '@fewprotocol/smart-order-router/build/main/providers/v3/pool-provider'
import _ from 'lodash'
import { ChainId, Currency, Ether, WETH9 } from '@fewprotocol/sdk-core'
