...
import { CachedRoute, UNI_MAINNET, USDC_MAINNET } from '@ring-protocol/smart-order-router'
import { MixedRoute } from '@ring-protocol/smart-order-router'
import { Pool as V3Pool } from '@ring-protocol/v3-sdk'
import { encodeSqrtRatioX96, FeeAmount } from '@ring-protocol/v3-sdk'
import { Pool as V4Pool } from '@ring-protocol/v4-sdk'
import { ADDRESS_ZERO, Protocol } from '@ring-protocol/router-sdk'
import { WNATIVE_ON } from '../../../../utils/tokens'
import { ChainId } from '@ring-protocol/sdk-core'
import { V3Route } from '@ring-protocol/smart-order-router'
