import { MixedRoute, V2Route, V3Route, V4Route, RingFewV2Route } from '@ring-protocol/smart-order-router/build/main/routers'
...
import { SupportedRoutes } from '@ring-protocol/smart-order-router'
