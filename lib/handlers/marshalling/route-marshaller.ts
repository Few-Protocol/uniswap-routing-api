import { MixedRoute, V2Route, V3Route, V4Route } from '@fewprotocol/smart-order-router/build/main/routers'
...
import { SupportedRoutes } from '@fewprotocol/smart-order-router'
