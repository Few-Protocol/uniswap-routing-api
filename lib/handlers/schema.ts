...
import { MethodParameters } from '@ring-protocol/smart-order-router'
...
export type SupportedPoolInRoute = V2PoolInRoute | V3PoolInRoute | V4PoolInRoute | FewV2PoolInRoute
