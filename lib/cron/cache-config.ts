...
import { V2SubgraphProvider, V3SubgraphProvider, V4SubgraphProvider } from '@fewprotocol/smart-order-router'
import { ChainId } from '@uniswap/sdk-core'
import { EulerSwapHooksSubgraphProvider } from '@fewprotocol/smart-order-router/'
import {
